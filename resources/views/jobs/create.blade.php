<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="/jobs" enctype="multipart/form-data">
            ...
            <x-inputs.text id='title' name="title" label="Job Title" type="text" />
            ...
            <x-inputs.text id='contact_phone' name="contact_phone" label="Contact Phone" type="text"
                placeholder="Enter phone" />

            <x-inputs.text id='contact_email' name="contact_email" label="Contact Email" type="email"
                placeholder="Enter where you want to receive applications" />
